...
gui.addColor(earthParameters, "atmosphereDayColor").onChange(() => {
  earthMaterial.uniforms.uAtomosphereDayColor.value.set(
    earthParameters.atmosphereDayColor
  );
  atmosphereMaterial.uniforms.uAtomosphereDayColor.value.set(
    earthParameters.atmosphereDayColor
  );
});
gui.addColor(earthParameters, "atmosphereTwilightColor").onChange(() => {
  earthMaterial.uniforms.uAtomosphereTwilightColor.value.set(
    earthParameters.atmosphereTwilightColor
  );
  atmosphereMaterial.uniforms.uAtomosphereTwilightColor.value.set(
    earthParameters.atmosphereTwilightColor
  );
});
